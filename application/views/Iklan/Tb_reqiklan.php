                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">Permintaan Iklan</h3>
                        </div><!-- /.box-header -->
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($data as $key => $val): ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><a href="<?php echo base_url('Request_iklan/update').'/'.$val->id_iklan ?>">Edit</a>&nbsp;||&nbsp;<a href="<?php echo base_url('Request_iklan/read').'/'.$val->id_iklan ?>">Tinjau</a>&nbsp;||&nbsp;
                                            <a href="<?php echo base_url('Iklan/delete').'/'.$val->id_iklan ?>">Delete</a></td>
                                        </tr>    
                                    <?php endforeach ?>
